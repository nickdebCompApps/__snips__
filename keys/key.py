...
mqtt_topics = ['hermes/intent/searchWeatherForecast',
...
api_keys = {'WEATHER_API':'',
            'YOUTUBE_API':'zaSyAJKJ7XbI0qttXJ4AS2QzEp91Hau06K',
            'YANDEX_API':'',
            'TWILIO_SID' : '',
            'TWILIO_TOKEN':'',
            'WEATHER_API':'',
